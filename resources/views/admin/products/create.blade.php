...
<div class="py-12">
        ...
        <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
            ...
            <div class="max-w-xl"> 
                ...
                <x-text-input wire:model="product_title" id="product_title" class="block mt-1 w-full" type="text" name="product_title" required autocomplete="product_title" />
                ...
                <textarea wire:model="product_description" id="product_description" class="block mt-1 w-full" name="product_description" required autocomplete="product_description"></textarea>
                ...
                <div class="mt-4">
                    ...
                    <select wire:model="product_cat" id="product_cat" class="block mt-1 w-full" name="product_cat" required autocomplete="product_cat">
                        ...
                        <option value="{{ $category->product_cat_name }}">{{ $category->product_cat_name }}</option>
                        @endforeach
                ...
                <x-text-input wire:model="product_link_url" id="product_link_url" class="block mt-1 w-full" type="link" name="product_link_url" required autocomplete="product_link_url" />
                <x-input-error :messages="$errors->get('product_link_url')" class="mt-2" />
                </div>

                <div class="mt-4">
                <x-input-label for="product_price" :value="__('Price')" />
                <x-text-input step="0.01" wire:model="product_price" id="product_price" class="block mt-1 w-full" type="number" name="product_price" required autocomplete="product_price" />
                <x-input-error :messages="$errors->get('product_price')" class="mt-2" />
                </div>

                <div class="mt-4">
                <x-input-label for="product_image" :value="__('Image')" />
                <x-text-input wire:model="product_image" id="product_image" class="block mt-1 w-full" type="file" name="product_image" required autocomplete="product_image" />
